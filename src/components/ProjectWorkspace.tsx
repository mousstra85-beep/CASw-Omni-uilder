...
export const ProjectWorkspace: React.FC<ProjectWorkspaceProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "code" | "apk" | "web" | "share" | "hosting" | "docs" | "github" | "publish" | "versions" | "chat"
  >("overview");
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-6 py-6 space-y-6 pb-20">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:opacity-95 disabled:opacity-50 text-white font-bold text-xs transition shadow-lg shadow-blue-900/30 flex items-center gap-2 active:scale-95"
              >
                <RefreshCw className={`w-4 h-4 ${isAiLoading ? "animate-spin" : ""}`} />
                <span>{isAiLoading ? "Synchronisation 3 IA..." : "Synchroniser / Régénérer"}</span>
              </button>
            </div>
          </div>
      ...
      <div className="flex border-b border-slate-800 gap-1 overflow-x-auto pb-1 text-xs font-semibold">
        {[
          ...
          { id: "github", label: "Exportation GitHub / ZIP", icon: Github },
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-xl space-y-3">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <span>Télécharger Projet Source (.zip)</span>
                </button>
              </div>
            </div>
          </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-base text-white">Exportation GitHub & Dépôt Git</h3>
                <p className="text-xs text-slate-400">
                  Export direct via Jeton d'Accès Personnel (PAT), synchronisation du code et archive ZIP
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Settings className="w-4 h-4 text-blue-400" />
                <span>Paramètres Détaillés</span>
              </button>

              <button
                onClick={handleDownloadProjectZip}
                className="px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs transition shadow-md flex items-center gap-2"
              >
                <Download className="w-4 h-4" />
          ...
          <div className="bg-slate-800/80 rounded-2xl p-5 border border-slate-700/60 space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              {githubUser ? (
                <span className="text-[10px] px-2.5 py-1 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 font-bold flex items-center gap-1.5">
                  <Check className="w-3 h-3" /> Connecté : @{githubUser.login}
                </span>
              ) : (
            ...
            <p className="text-xs text-slate-300">
              Saisissez votre Personal Access Token GitHub avec la permission <code className="text-emerald-400 bg-slate-900 px-1 py-0.5 rounded">repo</code> pour créer et pousser directement le code de votre application.
            </p>
            ...
            <div className="space-y-2">
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-950 border border-slate-700 rounded-xl text-xs font-mono text-white placeholder-slate-500 focus:ring-2 focus:ring-blue-500 outline-none pr-24"
                />
                <div className="absolute right-2 flex items-center gap-1">
                  <button
                    ...
                    title={showGithubPat ? "Masquer le jeton" : "Afficher le jeton"}
                  >
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 pt-1">
                <button
                  ...
                  className="px-3.5 py-2 rounded-xl bg-slate-700 hover:bg-slate-600 disabled:opacity-50 text-white font-bold text-xs transition flex items-center gap-1.5"
                >
                  <RefreshCw className={`w-3.5 h-3.5 ${isValidatingPat ? "animate-spin" : ""}`} />
                  <span>{isValidatingPat ? "Vérification..." : "Vérifier le Jeton"}</span>
                </button>
                ...
                >
                  <span>Générer un jeton sur GitHub</span>
                  <ExternalLink className="w-3 h-3" />
                </a>
              </div>
            </div>
            ...
            {githubExportResult && (
              <div className="p-4 bg-emerald-950/40 rounded-xl border border-emerald-500/40 space-y-3 animate-in fade-in">
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1">
                  ...
                  <button
                    type="button"
                    onClick={() => copyToClipboard(githubExportResult.repoUrl, "tab_gh_url")}
                  ...
                  >
                    {copiedText === "tab_gh_url" ? <Check className="w-3.5 h-3.5 text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                    <span>{copiedText === "tab_gh_url" ? "Copié !" : "Copier"}</span>
                  </button>
                  <a
            ...
            <button
              type="button"
              id="btn-direct-github-export-tab"
            ...
            >
              ...
              <span>
                {isExportingGithub
                  ...
                  : "Exporter Directement le Projet vers GitHub"}
              </span>
            </button>
          </div>

          {/* Section 2: Git CLI Commands */}
          <div className="p-4 bg-slate-800/80 rounded-2xl border border-slate-700/60 space-y-3 text-xs">
            <div className="flex items-center justify-between">
              <p className="font-bold text-white">Commandes Git manuelles (si vous préférez pousser via votre terminal) :</p>
              <button
                onClick={() =>
                  copyToClipboard(
                    `git init\ngit add .\ngit commit -m "Initial commit from AfriBuilder AI Studio"\ngit branch -M main\ngit remote add origin https://github.com/votre-compte/${project.title.toLowerCase().replace(/[^a-z0-9]/g, "-")}.git\ngit push -u origin main`,
                    "git_cmds"
                  )
                }
                className="px-2.5 py-1 rounded-lg bg-slate-700 hover:bg-slate-600 text-white text-[11px] font-semibold transition flex items-center gap-1"
              >
                {copiedText === "git_cmds" ? <Check className="w-3 h-3 text-emerald-400" /> : <Copy className="w-3 h-3" />}
                <span>{copiedText === "git_cmds" ? "Copié !" : "Copier les commandes"}</span>
              </button>
            </div>
            <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 font-mono text-emerald-400 space-y-1 text-xs">
              <p>git init</p>
              <p>git add .</p>
              <p>git commit -m "Initial commit from AfriBuilder AI Studio"</p>
              <p>git branch -M main</p>
              <p>git remote add origin https://github.com/votre-compte/{project.title.toLowerCase().replace(/[^a-z0-9]/g, "-")}.git</p>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-base text-white flex items-center gap-2">
              ...
              Explorateur de Code Source du Projet
            </h3>
            <button
            ...
            >
              ...
              <span>{copiedText === "file" ? "Copié !" : "Copier le fichier"}</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            {/* File Editor View */}
            <div className="md:col-span-3 bg-slate-950 p-4 rounded-2xl border border-slate-800 font-mono text-xs text-slate-300 max-h-[460px] overflow-auto">
